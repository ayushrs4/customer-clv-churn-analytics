...
PostgreSQL (SQL) – Data modeling, aggregation, RFM & CLV analysis
...
🔍 Methodology
1️⃣ Customer-Level Aggregation (SQL)
...
3️⃣ Business Impact Analysis (SQL)

Key insights from SQL analysis:

High-CLV customers contribute 48.6% of total revenue

High-CLV churn rate is 16.7%

9.35% of total revenue has already been lost due to churn among high-value customers

4️⃣ Churn Prediction (Python)
...
5️⃣ Predictive Risk & Customer Prioritization
...
Found that ~27% of total revenue is exposed to future churn risk if no retention action is taken

📈 Key Insights

A small segment of high-value customers drives nearly half of total revenue
